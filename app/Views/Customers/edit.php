...
<div class="content-wrapper">
    ...
    <div class="card border-top">
        ...
        <div class="card-body">
            <form method="POST" action="<?php echo base_url('user/edit/'.$ftdata['id'])?>" class="form small"
                name="createForm" id="createForm" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" name="name"
                            ...
                            id="name" placeholder="Name" value="<?php echo set_value('name',$ftdata['name']); ?>">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" name="email"
                            ...
                            id="email" placeholder="" value="<?php echo set_value('email', $ftdata['email']); ?>">
                    ...
                    <div class="form-group col-md-4 col-sm-6 ">
                        ...
                        <div class="radio-button" id="genderBox">
                            <input type="radio" id="radio1" name="gender"
                                <?php echo set_value('gender', $ftdata['gender']) == 'male'?'checked':''; ?>
                                value="male">
                            <label for="radio1">Male</label>

                            <input type="radio" id="radio2" name="gender"
                                <?php echo set_value('gender', $ftdata['gender']) == 'female'?'checked':''; ?>
                                value="female">
                            <label for="radio2">Female</label>

                            <input type="radio" id="radio3" name="gender"
                                <?php echo set_value('gender', $ftdata['gender']) == 'other'?'checked':''; ?>
                                value="other">
                    ...
                    <div class="form-group col-md-4 col-sm-6" autocomplete="off">
                        ...
                        <input type="text" name="password"
                            ...
                            id="password" value="<?= set_value('password', $ftdata['password'])?>">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <select name="designation" id="designation" value=" designation "
                            ...
                            <option value="Backend Develeper"
                                <?php echo set_value('designation', $ftdata['designation'])=='Backend Develeper'? 'selected' :'' ?>>
                                Backend
                                Developer</option>
                            <option value="Frontend Develper"
                                <?php echo set_value('designation', $ftdata['designation'])=='Frontend Develper'? 'selected' :''?>>
                                Frontend
                                Develop</option>
                            <option value="Graphic Designer"
                                <?php echo set_value('designation', $ftdata['designation'])=='Graphic Designer'? 'selected' :''?>>
                                Graphic
                                Designer</option>
                        </select>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" name="experience"
                            ...
                            id="experience" placeholder="In Years"
                            value="<?php echo set_value('experience', $ftdata['experience']); ?>">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <select name="qulification" id="education"
                            ...
                            <option value="">Select</option>
                            <option value="12th"
                                <?php echo set_value('qulification', $ftdata['qulification'])=='12th'? 'selected' :''?>>
                                12th
                            </option>
                            <option value="Diploma"
                                <?php echo set_value('qulification', $ftdata['qulification'])=='Diploma'? 'selected' :''?>>
                                Diploma</option>
                            <option value="B.Tech"
                                <?php echo set_value('qulification', $ftdata['qulification'])=='B.Tech'? 'selected' :''?>>
                                B.Tech</option>
                        </select>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" name="mobile"
                            ...
                            id="mobile" value="<?php echo set_value('mobile', $ftdata['mobile']); ?>">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <textarea
                            ...
                            rows="3"> <?php echo set_value('address', $ftdata['address']); ?> </textarea>
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" name="city"
                            ...
                            id="city" placeholder="" value="<?php echo set_value('city', $ftdata['city']); ?>">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" name="pincode"
                            ...
                            id="pincode" placeholder="" value="<?php echo set_value('pincode', $ftdata['pincode']); ?>">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" name="state"
                            ...
                            id="state" placeholder="" value="<?php echo set_value('state', $ftdata['state']); ?>">
                    ...
                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <input type="text" name="country"
                            ...
                            id="country" placeholder="" value="<?php echo set_value('country', $ftdata['country']); ?>">
                    ...
                    <div class="col-md-12 col-sm-12 col-lg-12">
                        <div class="form-group col-md-12  col-sm-12">
                            <input type="submit" class="btn btn-primary" id="submitBtn" value="Update" />
                        </div>
                    </div>
                </div>
            </form>
